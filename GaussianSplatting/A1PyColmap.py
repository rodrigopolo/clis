#!/usr/bin/env python3
"""
Run COLMAP reconstruction using pycolmap (Python bindings).
...
if __name__ == "__main__":
    ...
    parser.add_argument("--scenedir", type=Path, required=True,
                        help="Scene directory created by Exctract.sh")
    parser.add_argument(
        "--matcher",
        default="sequential",
